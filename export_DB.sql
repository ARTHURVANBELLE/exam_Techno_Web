...
CREATE TABLE `traduction` (
  ...
  `ndls` varchar(45) NOT NULL,
  `fr` varchar(45) NOT NULL,
  `rate` int DEFAULT NULL,
  `attempt` int DEFAULT NULL,
  `traductioncol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `traduction` VALUES (4,'slapen','dormir',14,8,NULL),(6,'Hoe','Comment',4,4,NULL);
...
-- Dump completed on 2023-12-20 11:02:51
